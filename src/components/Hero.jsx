...
// const Hero = ({arts}) => {
//     const [heroImg, setHeroImg] = useState(`${arts.config.iiif_url}/${arts.data[0].image_id}/full/843,/0/default.jpg`);
...
//                     <div className="hero-art-nav-container container">
//                         <div className="hero-art-nav">
//                             <img src="/images/hero_art_navs/hero_nav_img_1.png" alt="" className="firstImg" onClick={(e) => handleNavImageClick(e, `${arts.config.iiif_url}/${arts.data[0].image_id}/full/843,/0/default.jpg`)}></img>
//                         </div>
//                         <div className="hero-art-nav">
//                             <img src="/images/hero_art_navs/hero_nav_img_2.png" alt="" className="remove-border" onClick={(e) => handleNavImageClick(e, `${arts.config.iiif_url}/${arts.data[1].image_id}/full/843,/0/default.jpg`)}></img>
//                         </div>
//                         <div className="hero-art-nav">
//                             <img src="/images/hero_art_navs/hero_nav_img_3.png" alt="" className="remove-border" onClick={(e) => handleNavImageClick(e, `${arts.config.iiif_url}/${arts.data[2].image_id}/full/843,/0/default.jpg`)}></img>
//                         </div>
//                         <div className="hero-art-nav">
//                             <img src="/images/hero_art_navs/hero_nav_img_4.png" alt="" className="remove-border" onClick={(e) => handleNavImageClick(e, `${arts.config.iiif_url}/${arts.data[3].image_id}/full/843,/0/default.jpg`)}></img>
//                         </div>
//                     </div>
//                 </div>
//             </section>
