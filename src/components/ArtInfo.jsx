    ...
    return ( 
        ...
        <div className="artinfo-container">
            <div className="modal">
                ...
                {art.publication_history ? <div className="art-description container" dangerouslySetInnerHTML={{__html: art.publication_history}}></div> : <p className="art-description container">No publication history for this art</p>}
