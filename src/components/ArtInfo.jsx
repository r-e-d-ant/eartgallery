    ...
    return ( 
        ...
        <div className="artinfo-container">
            <div className="modal">
                ...
                {art.publication_history ? <p className="art-description container" dangerouslySetInnerHTML={{__html: art.publication_history}}></p> : <p className="art-description container">No publication history for this art</p>}
